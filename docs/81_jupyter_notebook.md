...
Usually, the conda will install the jupyter notebook (and the ipykernel) by default.
...
Then you can access jupyter notebook on your local browser using the link generated by jupyter notebook server.
