...
Let's check the results for HDLC:
...
Partitioned LD regression is utilized to evaluate the contribution of each functional group to the total SNP heritability.
