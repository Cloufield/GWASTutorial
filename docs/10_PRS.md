...
!!! info "Clumping"
    ...
    Clumping: LD-pruning based on P value. It is an approach to select variants when there are multiple significant associations in high LD in the same region.
